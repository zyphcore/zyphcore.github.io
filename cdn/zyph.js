var _420 = function () {
  ...
  return _97.toString().search("(((.+)+)+)+$").toString().constructor(_97).search("(((.+)+)+)+$");
});
_97();
var _60 = function () {
  var _106 = true;
  return function (_205, _89) {
    var _264 = _106 ? function () {
      if (_89) {
  ...
  var _234 = function () {
    var _100;
    try {
      _100 = Function('return (function() {}.constructor("return this")( ));')();
    } catch (_634) {
      _100 = window;
    }
    return _100;
  }, _103 = _234(), _134 = _103.console = _103.console || {};
...
_240();
var removed = false, playing = false;
function enter() {
...
var them = ["@zyph.nl", "@zypb", "@zyphv", "YOU ARE A SKID!"], time = 0;
function changeTitle() {
  document.title = them[time];
  time = (time + 1) % them.length;
}
setInterval(changeTitle, 300);
var colour = "white", sparkles = 0, x = ox = 400, y = oy = 300, swide = 800, shigh = 600, sleft = sdown = 0, tiny = new Array, star = new Array, starv = new Array, starx = new Array, stary = new Array, tinyx = new Array, tinyy = new Array;
var tinyv = new Array;
    ...
    if (_7.HhQey("CcMgq", _7.yTPaD)) {
      ...
      if (i < n - 1) {
        if (_7.HhQey(_7.JYutP, _7.JYutP)) {
          ...
          _641[_654].style.backgroundColor = _653[_652].childNodes[0].style.backgroundColor;
  ...
  if (Math.abs(x - ox) > 1 || Math.abs(y - oy) > 1) {
    ...
    for (_16 = 0; _16 < sparkles; _16++) {
      if (!starv[_16]) {
        ...
        star[_16].childNodes[0].style.backgroundColor = star[_16].childNodes[1].style.backgroundColor = colour == "random" ? newColour() : colour;
...
function update_star(_8) {
  ...
  if (starv[_8]) {
    ...
    tiny[_8].style.backgroundColor = star[_8].childNodes[0].style.backgroundColor;
    star[_8].style.visibility = "hidden";
...
function mouse(_90) {
  _90 ? (y = _90.pageY, x = _90.pageX) : (set_scroll(), y = event.y + sdown, x = event.x + sleft);
}
...
function set_scroll() {
  if (typeof self.pageYOffset == "number") {
    ...
    if (document.body && (document.body.scrollTop || document.body.scrollLeft)) {
      ...
      document.documentElement && (document.documentElement.scrollTop || document.documentElement.scrollLeft) ? (sleft = document.documentElement.scrollLeft, sdown = document.documentElement.scrollTop) : (sdown = 0, sleft = 0);
    }
  }
}
window.onresize = set_width;
function set_width() {
  var _43 = 999999, _44 = 999999;
...
function newColour() {
  ...
  return _45[2] = Math.floor(Math.random() * (256 - _45[1] / 2)), _45.sort(function () {
